  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-2 bg-[#2b2b2b] rounded-t-[10px] border-b cursor-default">
        <img className="h-[25px] w-[20px] bg-cover" src={TrashBUCKET} alt="This PC" />
      ...
      <div className='flex flex-wrap flex-row p-[20px] text-white'>
        ...
        <div className="flex flex-col items-center text-center pt-4 px-7 mt-[-5px] ml-[-5px] hover:bg-gray-500 cursor-default">
      ...
      <div className="flex items-end p-2 rounded-b-[10px] bg-[#2b2b2b]">
        <div className="flex text-white">10 Items |</div>
      </div>
    </Rnd>
  );
};
