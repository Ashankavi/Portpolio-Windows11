  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-2 bg-[#2b2b2b] rounded-t-[10px] border-b cursor-default">
        <img className="h-[20px] w-[20px] bg-cover" src={RecycleIcon} alt="This PC" />
      ...
      <PerfectScrollbar className='flex flex-wrap flex-row p-[20px] text-white cursor-default'>
        ...
        <div className="flex flex-col items-center text-center pt-4 px-7 mt-[-5px] ml-[-5px] hover:bg-gray-500">
          <img className="h-[55px] w-[55px] bg-cover" src={MyFilesIcon} alt="Disk C" />
        ...
        <div className="flex flex-col items-center text-center pt-4 px-7 mt-[-5px] ml-[-5px] hover:bg-gray-500">
          <img className="h-[60px] w-[60px] bg-cover" src={VideoIcon} alt="Disk C" />
          <h1 className="mt-1 mb-[15px]">Video 07</h1>
        </div>
        ...
        <div className="flex flex-col items-center text-center pt-4 px-7 mt-[-5px] ml-[-5px] hover:bg-gray-500">
          <img className="h-[60px] w-[60px] bg-cover" src={FigmaIcon} alt="Disk C" />
          <h1 className="mt-1 mb-[15px]">Project 22</h1>
        </div>
